	function addPlayer(x,y) {
		...
		base.punchBoxRight = newRect(x+75, y-50, 75, 75, base);//The hitbox of the punch attack
		base.punchBoxRight.solid=false;
		base.punchBoxLeft = newRect(x-50, y-50, 75, 75, base);
...
//~~~~~~~~~~~~~~~~~~~~SET FUNCTIONS~~~~~~~~~~~~~~~~~~~~~~~~~		
		...
		base.sprite.setSpritePosition(base.rect.x,base.rect.y);
		}	
		base.checkCanMove = function(x,y, array){
			base.rect.x += x;
			base.rect.y += y;
